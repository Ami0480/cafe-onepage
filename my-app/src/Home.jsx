...
export default function Home() {
  return (
    <div className="relative w-full h-screen object-cover">
      <div className="absolute w-full h-screen bg-linear-to-b from-black via-black/40 to-transparent z-10"></div>
      <img
        src={HeroImage}
        alt="Cafe Hero"
      ...
      <div className="absolute inset-0 flex flex-col justify-center items-center text-center z-20">
        <h1 className="text-white font-aboreto text-5xl mb-2">Stone Street</h1>
